...
import logoLeftImage from '@assets/images/thebay.jpg';
...
export default ({ onPress }: PlayerProps) => {
  return (
    <SafeAreaView style={styles.root}>
      {/* <LinearGradient colors={['#0b3057', '#051c30']} style={StyleSheet.absoluteFill} /> */}
      <View style={styles.container}>
        ...
        <Image source={logoLeftImage as ImageSourcePropType} style={styles.cover} />
